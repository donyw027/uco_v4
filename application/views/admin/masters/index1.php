          ...
          <div class="card-body">
            <form method="post" class="row g-3">
              ...
              <?php elseif ($slug === 'users'): ?>
                ...
                <div class="col-md-6">
                  <label class="form-label">Jabatan / Signature Title</label>
                  <input type="text" name="position" class="form-control" value="<?= e($edit['position'] ?? ''); ?>" placeholder="Example: Director / Export Manager">
                  <small class="text-muted">Dipakai otomatis untuk tanda tangan dokumen.</small>
                </div>
                <div class="col-md-3">
