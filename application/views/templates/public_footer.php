<footer style="background:#081121;color:#cbd5e1;">
  <div class="container" style="padding:80px 0 26px;">
    <div class="row g-4">
      <div class="col-lg-4">
        <h4 class="text-white fw-bold mb-3">UCO Exportindo Consulting</h4>
        ...
        <div class="small-muted text-white-50">Built With Trust.</div>
      </div>
      ...
      <div class="col-lg-3 col-md-4">
        ...
        <div class="d-grid gap-2">
          <span><i class="fa-solid fa-envelope me-2"></i>sales@ucoexportindo.com</span>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center pt-4 mt-4 border-top border-secondary-subtle">
      <div>© <?= date('Y'); ?> UCO Exportindo Consulting. All Rights Reserved.</div>
      <div class="small-muted text-white-50"> trusted export </div>
    </div>
  </div>
</footer>
